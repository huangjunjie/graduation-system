...
<div class="container">
	...
	<div class="row clearfix" id="banner">
		<div class="col-md-11 column col-md-offset-1" >
			<img alt="180" src="images/banner.jpg" class="img-rounded" width="85%"/>
		</div>
	</div>
	<div class="row clearfix" id="content">
		...
		<div class="col-md-4 column table-bordered div-rounded" >
			<form role="form" id="input_info" action="login.action" method="post">
				<div class="form-group">
					 <label for="UID">学号</label><input type="text" class="form-control" id="UIDLabel" name="uid"/>
				</div>
				<div class="form-group">
