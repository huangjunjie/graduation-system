...
<body>
  <div class="panel admin-panel">
    ...
    <table class="table table-hover text-center">
      ...
      <c:forEach items="${StudentinfoList}" var="student" >   
      <tr>
        <td>${student.uid}</td>
        <td>${student.name}</td>
        <td>${student.sex}</td>
...
{
	location.href="${pageContext.request.contextPath}/aGetDerpSInfo.action?uid="+$(".input").val();
}

function changeup(data)
{
	location.href="${pageContext.request.contextPath}/aJumpUpdateSInfo.action?uid="+data;
}
</script>
</body></html>